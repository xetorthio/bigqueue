...
describe("Redis lua scripts",function(){
    ...
    describe("#getMessage",function(){
        ...
        it("should put the message id into topics:topic:consumers:consumer:processing with the expiration time equals to tms+visibilityWindow")
        it("should move to topics:topic:consumers:consumer:fails the expired message into topics:topic:consumers:consumer:processing")
        it("should get a failed message over an stander message if topics:topic:consumers:consumer:fails is not empty")
