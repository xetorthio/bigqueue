...
describe("bigqueue", function(){
        ...
        describe("#postMessage()", function(){
           ...
           it("Should balance between the redis servers")
           ...
           it("Should load the message key into each consummers:topic:consumer queue registered into topics:topic:consumers list")
